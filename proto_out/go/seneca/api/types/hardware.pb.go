...
type Camera struct {
	...
	// The vehicle this camera is associated with at this current time.
...
func (x *Camera) GetVehicleId() string {
	if x != nil {
		return x.VehicleId
	}
	return ""
...
var file_hardware_proto_rawDesc = []byte{
	...
	0x22, 0x37, 0x0a, 0x06, 0x43, 0x61, 0x6d, 0x65, 0x72, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x76, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x49, 0x64, 0x42, 0x12, 0x5a, 0x10, 0x73, 0x65, 0x6e,
	0x65, 0x63, 0x61, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70,
...
var file_hardware_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
